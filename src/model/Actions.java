...
public abstract class Actions {
	...
	public static void lookingForDot(Pacman pacman) {
	...
	public static void lookingForFruit(Pacman pacman) {
	...
	public static void lookingForGhosts(Pacman pacman) {
		int ghostEated = 0;
	...
	public static void lookingForPacman(Pacman pacman) {
		for (Ghost ghost : Game.getGhostsArray()) {
			if (pacman.getBoardPosition().equals(ghost.getBoardPosition())) {
